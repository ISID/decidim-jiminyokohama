    ...
    module ParticipatoryProcesses
      ...
      class ParticipatoryProcessesController < Decidim::ParticipatoryProcesses::ApplicationController
        ...
        def promoted_participatory_processes
          tmp ||= published_processes| PromotedParticipatoryProcesses.new
          @promoted_participatory_processes = tmp.sort {|a, b| a.updated_at <=> b.updated_at}.reverse 
        end
        ...
        def default_date_filter
          return "past" if published_processes.any?(&:past?)#ハイライトされてない議題の表示のデフォルトは過去
